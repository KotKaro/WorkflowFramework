...
namespace Application.IntegrationTests.Commands.CompareExpectation.CompareExpectation.AddBiggerThanExpectation
{
    [Collection(nameof(TestCollections.ApplicationIntegrationCollection))]
    public class AddBiggerThanExpectationCommandHandlerTests : CommandTestBase
    {
        public AddBiggerThanExpectationCommandHandlerTests(ApplicationFixture applicationFixture) : base(applicationFixture)
        {
        }
        ...
        public async Task When_CommandIsInvalid_Expect_ValidationExceptionThrown()
        {
            ...
            {
                await mediator!.Send(new AddBiggerThanExpectationCommand
                {
        ...
        public async Task When_CommandIsValid_Expect_StepNavigatorGotExpectation()
        {
            ...
            var equalExpectation = stepNavigatorFromDb.Expectations.First() as BiggerThanExpectation;
