...
namespace Application.IntegrationTests.Commands.RemoveTypeMetadataCommand
{
    ...
    public class RemoveTypeMetadataCommandHandlerTests
    {
        ...
        public void When_IncorrectDataProvided_Expect_ValidationExceptionThrown()
        {
            ...
            {
                await mediator!.Send(new Application.Commands.RemoveTypeMetadataCommand.RemoveTypeMetadataCommand
                {
                    AssemblyFullName = "",
                    TypeFullName = ""
                });
        ...
        public async Task When_CorrectDataProvided_Expect_TypeMetadataRemovedFromDatabase()
        {
            ...
            await mediator!.Send(new Application.Commands.AddTypeMetadataCommand.AddTypeMetadataCommand
            {
